...
import getApexData from '@salesforce/apex/multiSelectCombo1.getInitialData';
import getApexData1 from '@salesforce/apex/multiSelectCombo1.getSearchValues';

export default class MultiSelectCombo1 extends LightningElement {
    // @api options;
    // @api selectedValue;
    //  @api selectedValues = [];
    options
    ...
    connectedCallback() {
        ...
        var optionData = [{ 'label': 'Bob', 'value': '123' },
    ...
    handleChange(event) {
        ...
        if (searchedtext) {
            getApexData1({ searchString: searchedtext })
                .then(result => {
            ...
            getApexData({ paramName: paramValue })
                .then(result => {
                    console.log('Result', result);
                })
                .catch(error => {
